      ...
      _export("ViewRegisterMgr", ViewRegisterMgr = class ViewRegisterMgr extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        constructor() {
          ...
          Object.keys(this.ViewType).forEach(system => {
            ...
            var module = this.ViewType[system];
            Object.keys(module.prefab).forEach(view => {
              var _arr$isShowBg;

              var arr = module.prefab[view];
              var isHidden = (_arr$isShowBg = arr.isShowBg) !== null && _arr$isShowBg !== void 0 ? _arr$isShowBg : false; // log("ViewRegisterMgr:ctor() view [ %s ] [ %s ]",view,isHidden.toString());
        ...
        getViewInfo(name, prefabName) {
          ...
          var module = this.ViewType[name];
          var cfg = module.prefab[prefabName];
          return {
            System: name,
            View: prefabName,
            Path: cfg.path,
