    ...
    execute: function () {
      ...
      _export("EnterApp", EnterApp = class EnterApp {
        ...
        init() {
          ...
          var uiCamera = (_find = find("Canvas")) === null || _find === void 0 ? void 0 : (_find$getChildByName = _find.getChildByName("UICamera")) === null || _find$getChildByName === void 0 ? void 0 : _find$getChildByName.getComponent(Camera);
          (_crd && gameMgr === void 0 ? (_reportPossibleCrUseOfgameMgr({
            error: Error()
          }), gameMgr) : gameMgr).setCamera("UICamera", uiCamera);
          var fightCamera = (_find2 = find("Canvas")) === null || _find2 === void 0 ? void 0 : (_find2$getChildByName = _find2.getChildByName("MainCamera")) === null || _find2$getChildByName === void 0 ? void 0 : _find2$getChildByName.getComponent(Camera);
          (_crd && gameMgr === void 0 ? (_reportPossibleCrUseOfgameMgr({
            error: Error()
