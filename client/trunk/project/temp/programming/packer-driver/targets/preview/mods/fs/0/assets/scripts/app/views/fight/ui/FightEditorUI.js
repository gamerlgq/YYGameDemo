  ...
  return {
    ...
    execute: function () {
      ...
      _export("FightEditorUI", FightEditorUI = (_dec = ccclass('FightEditorUI'), _dec2 = property(ScrollView), _dec3 = property(ProgressBar), _dec(_class = (_class2 = (_temp = class FightEditorUI extends Component {
        ...
        _initScrollView() {
          var items = (_crd && FightConstant === void 0 ? (_reportPossibleCrUseOfFightConstant({
            error: Error()
          ...
          var delegate = {
            ...
            reuse(itemNode, item) {
              var label = itemNode.getChildByName("Label");
              var lblCom = label.getComponent(Label);
              lblCom.string = item;
            }

          };
          var listViewComp = this.scrollView.getComponent(_crd && ListView === void 0 ? (_reportPossibleCrUseOfListView({
            error: Error()
          }), ListView) : ListView);
