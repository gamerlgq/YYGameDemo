      ...
      _export("FightFormation", FightFormation = (_dec = ccclass('FightFormation'), _dec2 = property(Node), _dec3 = property(Prefab), _dec(_class = (_class2 = (_temp = class FightFormation extends (_crd && LayerBase === void 0 ? (_reportPossibleCrUseOfLayerBase({
        ...
        _init() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this._showGerneralIconListByType();
        ...
        _initPosInfo() {
          for (var index = 0; index < 5; index++) {
            var posNode = find("bottom/pos_" + (index + 1), this.node);
        ...
        onClickDown(event) {
          ...
          if (target.children.length > 0) {
            var posInfo = this._upPosMap.get(target);
        ...
        _showGerneralIconListByType() {
          for (var index = 0; index < 20; index++) {
            var icon = instantiate(this.rewardItemIconPrefab);
        ...
        _onUp(event) {
          ...
          var generalIconShowComp = node.getComponent(_crd && GeneralIconShowComp === void 0 ? (_reportPossibleCrUseOfGeneralIconShowComp({
            error: Error()
          }), GeneralIconShowComp) : GeneralIconShowComp);
          ...
          if (!generalIconShowComp.isSel) {
            ...
            for (var iterator of this._posList) {
        ...
        _playMove(node, targetNode, endFunc) {
          //复制一个目标
          var nodeTween = instantiate(node);
          var startPos = node.getComponent(UITransform).convertToWorldSpaceAR(v3(0, 0, 0));
          startPos = this.node.getComponent(UITransform).convertToNodeSpaceAR(startPos);
          var endPos = targetNode.getComponent(UITransform).convertToWorldSpaceAR(v3(0, 0, 0));
