  ...
  return {
    ...
    execute: function () {
      ...
      NetLoadingMgr = class NetLoadingMgr extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        init() {
          var node = new Node("NetLoadingMgr");
        ...
        timeup(msg) {
          ...
          var msgEvent = new (_crd && Message === void 0 ? (_reportPossibleCrUseOfMessage({
            error: Error()
        ...
        addMsgLoading(id, timeout) {
          if (timeout === void 0) {
            timeout = 10;
          }

          var idStr = id + "";
          var endTime = timeout > 0 ? this._time + timeout : 0;
        ...
        removeMsgLoading(id) {
          ...
          for (var index = 0; index < this._msgList.length; index++) {
            var element = this._msgList[index];
