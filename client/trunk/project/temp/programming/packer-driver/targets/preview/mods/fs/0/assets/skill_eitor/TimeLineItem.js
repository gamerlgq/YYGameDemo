  ...
  return {
    ...
    execute: function () {
      ...
      _export("TimeLineItem", TimeLineItem = (_dec = ccclass('TimeLineItem'), _dec2 = property(Prefab), _dec(_class = (_class2 = (_temp = class TimeLineItem extends Component {
        ...
        set type(value) {
          this._type = value;
          var labelNode = find("Button/Label", this.node);
        ...
        set time(value) {
          this._time = value;
          var labelNode = find("timeBtn/Label", this.node);
        ...
        onClickSetTime() {
          var setTimePanel = instantiate(this.setTimePanelPrefab);
          var setTimePanelComp = setTimePanel.getComponent(_crd && TimeSetPanel === void 0 ? (_reportPossibleCrUseOfTimeSetPanel({
            error: Error()
