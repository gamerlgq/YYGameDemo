  ...
  return {
    ...
    execute: function () {
      ...
      _export("ResourcesLoader", ResourcesLoader = class ResourcesLoader {
        ...
        static get(path, type, bundleName) {
        ...
        static loadWithViewInfo(viewInfo, doneFunc, isShowLoading, type) {
          if (isShowLoading === void 0) {
            isShowLoading = true;
          }
        ...
        static loadList(pathList, onProcess, onComplete, bundleName) {
          if (bundleName === void 0) {
            bundleName = "resources";
          }
        ...
        static loadDir(path, onProcess, onComplete, bundleName) {
          if (bundleName === void 0) {
            bundleName = "resources";
          }
        ...
        static release(path, bundleName) {
          if (bundleName === void 0) {
            bundleName = "resources";
          }
        ...
        static addResRef(layerName) {
          var asset = ResourcesLoader._ResCounter.get(layerName);
