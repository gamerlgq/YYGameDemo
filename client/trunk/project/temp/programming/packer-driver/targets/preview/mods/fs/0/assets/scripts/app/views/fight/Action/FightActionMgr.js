    ...
    execute: function () {
      ...
      _export("FightActionMgr", FightActionMgr = class FightActionMgr extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        getAnimation(data) {
          ...
          var cmdEnum = this._getUnitActionEnumByName(cmd);
        ...
        getUnitAction(clas) {
          var anim = new clas(); // wait fot delet
        ...
        getUnit(who) {
          ...
          var com = this._fightMainWorld.getCommonentInLayer((_crd && FightConstant === void 0 ? (_reportPossibleCrUseOfFightConstant({
            error: Error()
        ...
        getUnitPos(who) {
          ...
          var pos = com.getFomationPos(camp, index);
