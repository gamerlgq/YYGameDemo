    ...
    execute: function () {
      ...
      DataMgr = class DataMgr extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        registerDataFile(dataHandlerName, path, parser) {
          var data = new (_crd && DataBase === void 0 ? (_reportPossibleCrUseOfDataBase({
            error: Error()
        ...
        getData(dataHandlerName, namekey) {
          var key = (namekey === null || namekey === void 0 ? void 0 : namekey.toString()) || "";

          var data = this._getDataCache(dataHandlerName);
        ...
        _getDataCache(dataHandlerName) {
          ...
          var data = this._dataMap.get(dataHandlerName);
        ...
        _loadDataWithIndex(dataHandlerName, pair, done) {
          ...
          if (data) {
            ...
            for (var index = start; index <= ended; index++) {
              if (index == ended) {
