    ...
    execute: function () {
      ...
      _export("AcitonJump", AcitonJump = class AcitonJump extends (_crd && ActionBase === void 0 ? (_reportPossibleCrUseOfActionBase({
        ...
        jump(data, callback) {
          ...
          var tarPos = this._getTargetPos(tar);

          var _middlePos = this._getMiddlePos(tarPos);

          var _scale = this._getScale(own);

          var _endPos = this._getEndPos(own, tarPos, new Vec3(...offset));
