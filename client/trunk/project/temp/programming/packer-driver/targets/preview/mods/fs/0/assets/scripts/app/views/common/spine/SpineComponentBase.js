  ...
  return {
    ...
    execute: function () {
      ...
      _export("SpineComponentBase", SpineComponentBase = (_dec = ccclass('SpineComponentBase'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = (_temp = class SpineComponentBase extends (_crd && ComponentBase === void 0 ? (_reportPossibleCrUseOfComponentBase({
        ...
        addBloodUI(node) {
          var node_blood_ui = this._root.getChildByName("node_blood_ui");
        ...
        updateBlood(cur, top) {
          var com = this._root.getComponentInChildren(_crd && FightBloodUI === void 0 ? (_reportPossibleCrUseOfFightBloodUI({
            error: Error()
        ...
        changeEquip(skinName, oldSlotName, newSlotName) {
          var skin_origin = this._spine._skeleton.skin.name;
          var slot_origin = this.findSlot(oldSlotName);
          this.changeSkin(skinName);
          var slot_new = this.findSlot(newSlotName);
          var attachment_new = slot_new.getAttachment();
