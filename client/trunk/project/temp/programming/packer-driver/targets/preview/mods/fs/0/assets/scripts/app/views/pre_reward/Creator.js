System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, instantiate, log, sceneMgr, ResourcesLoader, ViewCreatorBase, ViewProtocol, viewRegisterMgr, PreRewardCreator, _crd;
  ...
  _export("PreRewardCreator", void 0);
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "82a84kJMT9AYKgLbEO54WD6", "Creator", undefined);

      _export("PreRewardCreator", PreRewardCreator = class PreRewardCreator extends (_crd && ViewCreatorBase === void 0 ? (_reportPossibleCrUseOfViewCreatorBase({
        error: Error()
        ...
        onInit() {
          ...
          this.regMsg((_crd && ViewProtocol === void 0 ? (_reportPossibleCrUseOfViewProtocol({
            error: Error()
          }), ViewProtocol) : ViewProtocol).PreviewReward, this.onCreate.bind(this));
        }
        ...
        onCreate(event) {
          ...
          var viewInfo = (_crd && viewRegisterMgr === void 0 ? (_reportPossibleCrUseOfviewRegisterMgr({
            error: Error()
          }), viewRegisterMgr) : viewRegisterMgr).getViewInfo("preReward", "preRewardMain");
          var path = viewInfo.Path;
