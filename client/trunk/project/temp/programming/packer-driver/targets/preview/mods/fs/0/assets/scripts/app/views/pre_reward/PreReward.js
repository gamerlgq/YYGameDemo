  ...
  return {
    ...
    execute: function () {
      ...
      _export("PreReward", PreReward = (_dec = ccclass('PreReward'), _dec(_class = class PreReward extends Component {
        ...
        setItems() {
          var listViewNode = find("content/ScrollView", this.node.parent);
          var _items = [];
          ...
          var listViewComp = listViewNode.getComponent(_crd && ListView === void 0 ? (_reportPossibleCrUseOfListView({
            error: Error()
          }), ListView) : ListView);
