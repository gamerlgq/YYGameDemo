    ...
    execute: function () {
      ...
      _export("FightController", FightController = class FightController extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        _initData() {
          ...
          var data = this._fightData.getRoundData();
        ...
        _playCameraAnimation() {
          ...
          var fightCamera = (_crd && gameMgr === void 0 ? (_reportPossibleCrUseOfgameMgr({
            error: Error()
          }), gameMgr) : gameMgr).getCamera("MainCamera");
          var animation = fightCamera === null || fightCamera === void 0 ? void 0 : (_fightCamera$node = fightCamera.node) === null || _fightCamera$node === void 0 ? void 0 : _fightCamera$node.getComponent(Animation);
          var scriptCom = fightCamera === null || fightCamera === void 0 ? void 0 : (_fightCamera$node2 = fightCamera.node) === null || _fightCamera$node2 === void 0 ? void 0 : _fightCamera$node2.getComponent(_crd && CameraLock === void 0 ? (_reportPossibleCrUseOfCameraLock({
            error: Error()
        ...
        _nextAction() {
          ...
          var action = this._roundData[this._action];
          var data = {
            Action: this._action,
            ActionData: action
          };
